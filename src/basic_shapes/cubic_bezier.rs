...
pub struct CubicBezier {
    ...
    pub ctrl1_point: Point,
    pub ctrl2_point: Point,
    pub end_point: Point,
    pub common: CommonVars,
}
impl CubicBezier {
    pub fn builder(start: &WPos, ctrl1: &WPos, ctrl2: &WPos, end: &WPos) -> BasicShapeTypes {
        let start = *start;
        let ctrl1 = *ctrl1;
        let ctrl2 = *ctrl2;
        let end = *end;
        ...
        BasicShapeTypes::CBezier(Box::new(cbezier))
    }
...
// impl BasicShape for CubicBezier {
